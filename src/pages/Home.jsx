...
import soheli from "../imgs/soheli.webp"
import surjo from "../imgs/surjo.webp"
import adrija from "../imgs/adrija.webp"
import jatin from "../imgs/jatin.webp"
  ...
  return (
    <main className="relative h-screen w-screen">
      ...
      <div className=" h-auto w-screen flex">
        <img src={encSmit} alt="banner" width={8000} height={800} />
      </div>
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 gap-6 ">
              <article className="bg-[#ffffffd5] p-8 rounded-3xl">
                <p className="text-justify md:text-[1.2rem] lg:text-[1.5rem] text-gray-900 font-medium indent-20 mt-8 leading-relaxed">
                  ...
                  strategies for positive social and environmental impact. It is
                  a non-profit organisation that uses the United Nations 17
                  Sustainable Development Goals as a framework to bring about a
                  change and create a better world for everyone. Enactus SMIT is
                  a newly formed chapter of this global platform. Since our
                  establishment in 2022, we&apos;ve been actively working on our
                  first project
                  <span className="lg:text-[1.6rem] font-semibold">
                    {" "}
                    अन्न-Drishti
                  </span>
                  . Backed by a strong core team and supportive local
                  businesses, we aim to make our surroundings more sustainable
                  than ever.
                </p>
              </article>
              <div className="relative grid place-items-center">
                <img src={encTran} alt="pic" />
              </div>
            </div>
          </section>
        </motion.div>
            ...
            <article className="flex-col w-[50%] mx-auto my-10">
              <div>
                <h1 className="text-slate-900 text-xl md:text-3xl font-semibold">
                  <span className="text-yellow-600">En</span>trepreneurial
                </h1>
                <p className="text-md md:text-xl font-medium ">
                  Having the perspective to see an opportunity and the talent to
                  create calue from that opportunity.
                </p>
              </div>
              <div>
                <h1 className="text-slate-900 text-xl md:text-3xl font-semibold">
                  <span className="text-yellow-600">Act</span>ion
                </h1>
                <p className="text-md md:text-xl font-medium ">
              ...
              <div>
                ...
                <p className="text-md md:text-xl font-medium ">
                  A group of people who see themselves connected in some
