    ...
    <div className="flex flex-col w-auto justify-between overflow-hidden pt-7 bg-white z-50 ">
      ...
      <div className="flex absolute inset-y-0 right-0 top-0 md:hidden">
        <nav
          className={`${
            isOpen ? "w-[45vw]" : "w-0"
          } duration-[.3s] h-screen bg-slate-600/90`}
        >
          <ul
        ...
        md:hidden ${displayMenu ? "inline-block" : "hidden"}`}
          ...
          >
            ...
            <li className="cursor-pointer" onClick={() => routeChange("/team")}>
              Team 2022-2023
            </li>
            <li
      ...
      <div className="inline absolute py-10 px-4 inset-y-0 right-0 text-sm font-medium md:hidden cursor-pointer">
        <Bars3Icon
          className={`h-6 w-6 mr-3 fill-yellow-600 transition-transform duration-[.6] ${
